...
public class CenteredMaterialSheetFab<FAB extends View & AnimatedFab> extends MaterialSheetFab {
    public CenteredMaterialSheetFab(FAB fab, View sheet, View overlay, int sheetColor, int fabColor) {
        ...
        sheetAnimation = new CenteredMaterialSheetAnimation(sheet, sheetColor, fabColor, interpolator);
    }

    private static class CenteredMaterialSheetAnimation extends MaterialSheetAnimation {
        ...
        public CenteredMaterialSheetAnimation(View sheet, int sheetColor, int fabColor,
                                              Interpolator interpolator) {
            super(sheet, sheetColor, fabColor, interpolator);
            this.sheet = sheet;
