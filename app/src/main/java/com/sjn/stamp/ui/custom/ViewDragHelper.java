...
public class ViewDragHelper {
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelper create(ViewGroup forParent, Interpolator interpolator, ViewDragHelper.Callback cb) {
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, ViewDragHelper.Callback cb) {
     ...
     * @param interpolator interpolator for scroller
     */
    private ViewDragHelper(Context context, ViewGroup forParent, Interpolator interpolator, ViewDragHelper.Callback cb) {
        if (forParent == null) {
