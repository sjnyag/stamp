...
public class TvBrowseActivity extends FragmentActivity
    ...
    public static final String SAVED_MEDIA_ID = "com.sjn.stamp.MEDIA_ID";
    public static final String BROWSE_TITLE = "com.sjn.stamp.BROWSE_TITLE";
