...
import com.sjn.taggingplayer.ui.item.ScrollableExpandableItem;
import com.sjn.taggingplayer.ui.item.ScrollableFooterItem;
import com.sjn.taggingplayer.ui.item.ScrollableLayoutItem;
import com.sjn.taggingplayer.ui.item.ScrollableSubItem;
...
public class SongAdapter extends FlexibleAdapter<AbstractFlexibleItem> {
    ...
    public void addUserLearnedSelection(boolean scrollToPosition) {
        /*
        if (!DatabaseConfiguration.userLearnedSelection && !hasSearchText() && !(getItem(0) instanceof OverallItem)) {
